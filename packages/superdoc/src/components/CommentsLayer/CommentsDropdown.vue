    ...
    <Teleport to="body">
      <div v-if="isOpen" ref="menuRef" class="comments-dropdown__menu" :style="menuStyle">
        ...
        >
          ...
          <!-- Keep legacy class for click-outside checks in CommentDialog/SuperDoc -->
          <span class="comments-dropdown__option-label n-dropdown-option-body__label">{{ option.label }}</span>
        </div>
      </div>
    </Teleport>
  </div>
